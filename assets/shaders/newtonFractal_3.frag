...
vec2 ThirdDegreePolynomialDerivative(vec2 z, vec2 a, vec2 b, vec2 c)
{
    ...
    //3a^2
    vec2 secondDegree = ComplexMultiply(ComplexMultiply(vec2(3.0, 0.0), a), ComplexMultiply(z, z));

    //2bz
    vec2 firstDegree = ComplexMultiply(ComplexMultiply(vec2(2.0, 0.0), b), z);
...
void main()
{
    ...
    float tolerance = 0.5; //0.000001; //TODO: tweak
